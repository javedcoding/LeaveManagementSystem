...
namespace LeaveManagementSystem.Web.Services.LeaveRequests
{
        ...
        ApplicationDbContext _context, ILeaveAllocationsService _leaveAllocationsService ) : ILeaveRequestsService
    {
        public async Task CancelLeaveRequest(int leaveRequestId)
        {
            ...
            leaveRequest.LeaveRequestStatusId = (int)LeaveRequestStatusEnum.Cancled;
        ...
        public async Task<bool> RequestDatesExceedAllocation(LeaveRequestCreateVM model)
        {
            ...
            var allocation = await _context.LeaveAllocations.FirstAsync(q => q.LeaveTypeId == model.LeaveTypeId && q.EmployeeId == user.Id && q.PeriodId == period.Id);
        ...
        public async Task<ReviewRequestVM> GetLeaveRequestForReview(int id)
        {
